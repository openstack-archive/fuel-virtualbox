...
Mirantis VirtualBox scripts are used to automate the installation of the Fuel
and Mirantis OpenStack. When you install Mirantis OpenStack using the Mirantis
...
with all required settings automatically. However, you must place the latest
...
If you run this script under Cygwin, it will automatically add the path to
VirtualBox directory to your PATH automatically.
